...
const ContentSection = ({ selectedKey }) => {
  const contentMap = {
    terms: {
      ...
      intro:
        "Lwoang.inc is committed to protecting your personal information when you access our website. Please read the Terms of Service below to understand your rights and obligations.",
      sections: [
        {
          title: "1. Acceptance of Terms",
          text: "By accessing or using Lwoang.inc, you agree to be bound by these Terms of Service. This includes agreeing to our policies on orders, payments, and usage of our services. If you do not agree, please refrain from using our website.",
        },
        {
          title: "2. Product Information and Pricing",
          text: "We strive to ensure that all product descriptions, images, and pricing are accurate. However, Lwoang.inc does not guarantee that all information is error-free. We reserve the right to modify or update information at any time without prior notice.",
        },
        {
          title: "3. Orders and Payments",
          text: "When placing an order, you agree to provide accurate personal information (e.g., name, email, phone number, address). Lwoang.inc is not responsible for errors due to incorrect information provided by you. All payments must be completed before order fulfillment.",
        },
        {
          title: "4. Intellectual Property",
          text: "All content on Lwoang.inc, including images, text, and designs, is protected by intellectual property laws. Unauthorized use, reproduction, or distribution is prohibited without prior written consent.",
        },
        {
    ...
    privacy: {
      ...
      intro:
        "Lwoang.inc is committed to safeguarding your personal information. Below is our Privacy Policy outlining how we collect, use, and protect your data.",
      sections: [
        {
    ...
    shipping: {
      ...
      intro:
        "Lwoang.inc provides reliable shipping services. Below are the details of our shipping process.",
      sections: [
        {
    ...
    returns: {
      title: "Return Policy",
      intro:
        "Lwoang.inc offers a hassle-free return process for eligible items. Please review our policy below.",
      sections: [
        {
