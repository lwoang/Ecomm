...
router.get("/", (req, res) => {
  res.send(`
    ...
    <head>
      ...
      <title>Lwoang E-Commerce API</title>
      <style>
        body {
    ...
    <body>
      <div class="container">
        <h1>🛍️ Lwoang E-Commerce API</h1>
        <p>Welcome to the official API of Lwoang — your destination for stylish clothes, premium accessories, and modern lifestyle products.</p>
        ...
        <div class="footer">
          © ${new Date().getFullYear()} Lwoang. All rights reserved.
        </div>
      </div>
    </body>
    </html>
