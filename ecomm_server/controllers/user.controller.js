...
export const register = async (req, res) => {
  ...
  try {
    ...
    const emailSubject = "Confirm Your Email - Lwoang Registration";
...
<body>
  <div class="container">
    <div class="header">
      <h1>Welcome to Lwoang</h1>
      <p style="margin: 5px 0; color: #666;">Complete Your Registration</p>
    </div>
    <div class="message">
      <p>Hello,</p>
      <p>Thank you for signing up with <strong>Lwoang</strong>. To activate your account, please enter the confirmation code below or click the activation link:</p>
    ...
    <div class="footer">
      &copy; ${new Date().getFullYear()} Lwoang. All rights reserved.
    </div>
  </div>
</body>
</html>
